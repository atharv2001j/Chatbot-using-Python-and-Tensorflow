...
# Load preprocessed data (words and classes) and the trained model
...
def predict_class(sentence):
    ...
    # Minimum probability of considering the intent
...
# You Can add as many intents as you want but keep the same format .